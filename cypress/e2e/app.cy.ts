...
describe("TodoMVC - React", function () {
  ...
  it("adds 2 todos", function () {
    Todos.newTodos.type("learn testing{enter}").type("be cool{enter}");
  ...
  context("New Todo", function () {
    ...
    it("should allow me to add todo items", function () {
      // create 1st todo
      Todos.newTodos.type(TODO_ITEM_ONE).type("{enter}");
      ...
      Todos.todoList
        ...
        .find("label")
        .should((element) => {
          expect(element).to.contain(TODO_ITEM_ONE);
        });

      // create 2nd todo
      Todos.newTodos.type(TODO_ITEM_TWO).type("{enter}");
      ...
      Todos.todoList
        ...
        .find("label")
        .should((element) => {
          expect(element).to.contain(TODO_ITEM_TWO);
        });
    });
    ...
    it("should clear text input field when an item is added", function () {
      ...
      Todos.newTodos.first().should((element: JQuery<HTMLInputElement>) => {
    ...
    it("should trim text input", function () {
      ...
      Todos.todoList.eq(0).should((element) => {
        expect(element).to.have.text(TODO_ITEM_ONE);
      });
    });
  ...
  context("Mark all as completed", function () {
    ...
    it("complete all checkbox should update state when items are completed / cleared", function () {
      ...
      Todos.todoList.eq(0).as("firstTodo").find(".toggle").uncheck();
  ...
  context("Contrast", () => {
    ...
    it("has good contrast with several todos", () => {
      ...
      Todos.todoList.should((element) => expect(element).have.length(2));
      cy.checkA11y(null, {
        runOnly: ["cat.color"],
      });

      // and after marking an item completed
      Todos.todoList.first().find(".toggle").check();

      Todos.todoList.first().should((element) => {
        expect(element).to.have.class("completed");
      });
